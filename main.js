...
myPresentation.body.textContent = "Hi, I'm Pedro Omar iOS Developer, I'm 25 years old.";
document.body.appendChild(myPresentation);

wifiConnect.body.textContent = "Wifi Connect is a app that help to the users to use the Etecsa services with security nad stability.";
